...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { buyer_id: @trade.buyer_id, seller_id: @trade.seller_id, shift_id: @trade.shift_id }
    end
  ...
  test "should update trade" do
    patch :update, id: @trade, trade: { buyer_id: @trade.buyer_id, seller_id: @trade.seller_id, shift_id: @trade.shift_id }
    assert_redirected_to trade_path(assigns(:trade))
  end
